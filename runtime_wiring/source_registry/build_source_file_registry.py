...
_SOURCE_INVENTORIES: List[Tuple[str, pathlib.Path]] = [
    ...
    # P24 — Coverage gap repair: 3 new families
    (
        "RSSI_SECURITY_PRESENTATION",
        _REPO_ROOT / "_source_discovery/P24_SOURCE_PACK_COVERAGE_REPAIR_20260603/F11_RSSI_SECURITY_ZIP_INTERNAL_INVENTORY.csv",
    ),
    (
        "EXTERNAL_SIGNALS",
        _REPO_ROOT / "_source_discovery/P24_SOURCE_PACK_COVERAGE_REPAIR_20260603/F04_EXTERNAL_SIGNALS_ZIP_INTERNAL_INVENTORY.csv",
    ),
    (
        "NARRATIVE_PROVENANCE_LAYER",
        _REPO_ROOT / "_source_discovery/P24_SOURCE_PACK_COVERAGE_REPAIR_20260603/F12_NPL_ZIP_INTERNAL_INVENTORY.csv",
    ),
]
