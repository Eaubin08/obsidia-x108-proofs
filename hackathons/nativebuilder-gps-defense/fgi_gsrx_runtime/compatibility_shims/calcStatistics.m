...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OCTAVE_COMPAT_SHIM: headless hackathon runtime computes the same
% statistics but skips the final diagnostic figure when no graphics toolkit
% is available. No navigation/statistics formulas are changed.
