...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% OCTAVE_COMPAT_SHIM: this hackathon-local copy only casts logical GPS NAV
% bits to double before dec2bin(), matching MATLAB behavior expected by
% upstream FGI-GSRx. Navigation decoding logic is unchanged.
