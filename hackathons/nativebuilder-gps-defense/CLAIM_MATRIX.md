...
Date: 2026-08-03
Status: PASS_REAL_RF_WITH_FGI_HOSTILE_RF_OBTAINED_GNSS_SDR_BLOCKED
...
| Official hostile RF benchmark | BLOCKED | `hackathons/nativebuilder-gps-defense/RECORDED_RF_ATTACK_REPORT.md` | "`RECORDED_RF_ATTACK` is specified and claim-gated, but not reached because GNSS-SDR/receiver execution is blocked before hostile RF observables/PVT." |
| TEXBAT / OAKBAT / FGI spoofing resistance | FALSE | `hackathons/nativebuilder-gps-defense/rf_attack_benchmark/metrics.json` | "No spoofing-resistance claim is allowed; hostile RF metrics were not computed." |
