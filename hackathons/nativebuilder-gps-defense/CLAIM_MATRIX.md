...
Date: 2026-08-02
Status: PASS_REAL_RF_WITH_BLOCKED_RF_ATTACK
...
| Official hostile RF benchmark | BLOCKED | `hackathons/nativebuilder-gps-defense/RECORDED_RF_ATTACK_REPORT.md` | "`RECORDED_RF_ATTACK` is specified and claim-gated, but not reached because no official hostile RF recording was obtained and processed." |
