# T01 — Réduction Incertitude / Audit cohérence

**Type :** TEST_T
**Protocole :** Test Ontologique 1
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Réduction Incertitude / Audit cohérence**.
Son protocole opératoire associé est : **Test Ontologique 1**.
