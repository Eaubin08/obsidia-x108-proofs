# T09 — Créativité / Mode réflexe

**Type :** TEST_T
**Protocole :** Test Ontologique 9
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Créativité / Mode réflexe**.
Son protocole opératoire associé est : **Test Ontologique 9**.
