# T11 — Génération Aléatoire / Frugalité bio-inspirée

**Type :** TEST_T
**Protocole :** Test de Frugalité
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Génération Aléatoire / Frugalité bio-inspirée**.
Son protocole opératoire associé est : **Test de Frugalité**.
