# T08 — Auto-Organisation / Apprentissage inversé

**Type :** TEST_T
**Protocole :** Test Ontologique 8
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Auto-Organisation / Apprentissage inversé**.
Son protocole opératoire associé est : **Test Ontologique 8**.
