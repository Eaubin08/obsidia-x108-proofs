# A24 — Prédictibilité / Métriques et veille

**Type :** MODULE_A
**Protocole :** Gardien des Métriques
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Prédictibilité / Métriques et veille**.
Son protocole opératoire associé est : **Gardien des Métriques**.
