# A17 — Complexité Minimale / Apprentissage universel

**Type :** MODULE_A
**Protocole :** Apprentissage Fractal
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Complexité Minimale / Apprentissage universel**.
Son protocole opératoire associé est : **Apprentissage Fractal**.
