# A13 — Sécurité Interactions / Mode réflexe

**Type :** MODULE_A
**Protocole :** Simulation ↔ Activation
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Sécurité Interactions / Mode réflexe**.
Son protocole opératoire associé est : **Simulation ↔ Activation**.
