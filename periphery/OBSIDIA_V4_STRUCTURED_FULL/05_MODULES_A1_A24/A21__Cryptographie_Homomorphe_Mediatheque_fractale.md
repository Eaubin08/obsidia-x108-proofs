# A21 — Cryptographie Homomorphe / Médiathèque fractale

**Type :** MODULE_A
**Protocole :** Protocole Réactivation
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Cryptographie Homomorphe / Médiathèque fractale**.
Son protocole opératoire associé est : **Protocole Réactivation**.
