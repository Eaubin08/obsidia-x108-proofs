# A20 — Confidentialité / Entraînement émotionnel

**Type :** MODULE_A
**Protocole :** Friction-Shazam
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Confidentialité / Entraînement émotionnel**.
Son protocole opératoire associé est : **Friction-Shazam**.
