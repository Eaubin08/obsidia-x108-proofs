...
- Previous HEAD: 5ee3784
- Cause: runbook still expected PASS for pointers whose real committed status is READY.
- Correction: runner now validates against real pointer STATUS fields.
- No reset.
- No rebase.
- No history smoothing.
- Real pointer statuses retained.

## Real statuses used by V3
...
- CURRENT_BRODY_NATIVE_TERMINAL_SESSION_TEST_READONLY.txt: BRODY_NATIVE_TERMINAL_SESSION_TEST_READONLY_READY
- CURRENT_BRODY_NATIVE_TERMINAL_DETECTOR_PATCH_READONLY.txt: BRODY_NATIVE_TERMINAL_DETECTOR_PATCH_READONLY_READY
