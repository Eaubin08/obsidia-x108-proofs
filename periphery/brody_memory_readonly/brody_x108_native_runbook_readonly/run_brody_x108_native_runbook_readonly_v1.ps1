...
$checks = @(
  ...
  @{ file = "CURRENT_MEMORY_LAYER_AUTHORITY_MODEL_READONLY.txt"; status = "MEMORY_LAYER_AUTHORITY_MODEL_READONLY_READY" },
  @{ file = "CURRENT_BRODY_X108_PROOF_STATE_FREEZE_V1.txt"; status = "BRODY_X108_PROOF_STATE_FREEZE_V1_READY" },
  ...
  @{ file = "CURRENT_BRODY_API_BRIDGE_LIVE_DRIFT_GUARD_READONLY.txt"; status = "BRODY_API_BRIDGE_LIVE_DRIFT_GUARD_READONLY_READY" },
