# A16 — Récursivité / Architecture du savoir

**Type :** MODULE_A
**Protocole :** Loi du noyau-mère
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Récursivité / Architecture du savoir**.
Son protocole opératoire associé est : **Loi du noyau-mère**.
