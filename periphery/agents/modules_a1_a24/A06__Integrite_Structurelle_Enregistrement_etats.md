# A06 — Intégrité Structurelle / Enregistrement états

**Type :** MODULE_A
**Protocole :** Mémoire Vivante (MV) / Audit
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Intégrité Structurelle / Enregistrement états**.
Son protocole opératoire associé est : **Mémoire Vivante (MV) / Audit**.
