# A23 — Causalité / Calibration procédurale

**Type :** MODULE_A
**Protocole :** Loi de Calibration
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Causalité / Calibration procédurale**.
Son protocole opératoire associé est : **Loi de Calibration**.
