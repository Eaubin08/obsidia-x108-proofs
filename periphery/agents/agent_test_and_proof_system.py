"""
Readonly validator for the AGENT_TEST_AND_PROOF_SYSTEM Wave004 index.

Source: periphery/agents/agent_test_and_proof_system.index.json
...
_INDEX_REL_PARTS = (
    "periphery",
    "agents",
    "agent_test_and_proof_system.index.json",
)

_SUPPORTED_SCHEMA = "1.0"
_EXPECTED_INDEX_ID = "AGENT_TEST_AND_PROOF_SYSTEM_INDEX_V1"
