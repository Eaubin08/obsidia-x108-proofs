import Std
            ...
            -- Rationale : Obsidure: prends l’item Espace_Etat_Obsidia uniquement et génère une proposal dont l’unique patch crée exactement periphery/lean_sandbox/Espace_Etat_S
            --
...
-- Objectif: Obsidure: prends l’item Espace_Etat_Obsidia uniquement et gé

                theorem P38_Obsidure__prends_l_item_Espace_Etat_t1 : ∀ (n m : Nat), n + m = m + n := by
                  intro n m
                  omega