import Std
            ...
            -- Rationale : Obsidure: prends l’item DecisionTicket_Formel uniquement et génère une proposal dont l’unique patch crée exactement periphery/lean_sandbox/DecisionTic
            --
...
-- Objectif: Obsidure: prends l’item DecisionTicket_Formel uniquement et 

                theorem P38_Obsidure__prends_l_item_DecisionTic_t1 : ∀ (n m : Nat), n + m = m + n := by
                  intro n m
                  omega