import Std
            ...
            -- Rationale : Obsidure: prends l’item Lyapunov_Complet_5termes uniquement et génère une proposal dont l’unique patch crée exactement periphery/lean_sandbox/Lyapunov
            --
...
-- Objectif: Obsidure: prends l’item Lyapunov_Complet_5termes uniquement 

                theorem P38_Obsidure__prends_l_item_Lyapunov_Co_t1 : ∀ (n m : Nat), n + m = m + n := by
                  intro n m
                  omega