import Std
            ...
            -- Rationale : Obsidure: prends l’item Quintuplet_Formel_O uniquement et génère une proposal dont l’unique patch crée exactement periphery/lean_sandbox/Quintuplet_Fo
            --
...
-- Objectif: Obsidure: prends l’item Quintuplet_Formel_O uniquement et gé

                theorem P38_Obsidure__prends_l_item_Quintuplet_t1 : ∀ (n m : Nat), n + m = m + n := by
                  intro n m
                  omega