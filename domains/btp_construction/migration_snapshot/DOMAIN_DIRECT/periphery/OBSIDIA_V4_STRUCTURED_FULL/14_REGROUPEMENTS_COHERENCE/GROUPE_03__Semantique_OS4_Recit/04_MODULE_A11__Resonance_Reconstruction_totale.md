# A11 — Résonance / Reconstruction totale

**Type :** MODULE_A
**Protocole :** Loi de Reconstruction
**Statut source :** [x] Intégré
**Test V4 :** [ ] Test V4

## Ce que fait ce module
Ce module porte la fonction : **Résonance / Reconstruction totale**.
Son protocole opératoire associé est : **Loi de Reconstruction**.
