"""
Tests for periphery.agents.operational_system_registry — Wave 002.
...
from periphery.agents.operational_system_registry import (
...
def _reset_cache():
    ...
    import periphery.agents.operational_system_registry as mod
...
def test_w2_001_manifest_file_exists():
    """operational_system_manifest.json exists at the expected path."""
