...
# ---------------------------------------------------------------------------
# WC-086 to WC-090 — regression: global registration blocked preserved
# ---------------------------------------------------------------------------

def test_wc_086_global_registration_blocked_preserved():
    ...
    with open(artifact_idx, encoding="utf-8") as f:
        data = json.load(f)
    assert data.get("global_registration_blocked") is True
