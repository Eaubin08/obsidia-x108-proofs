    ...
    if req.compact or req.debug:
        try:
            ...
            if _fp_result.get("fastpath_allowed", False):
                # Preserve the public response contract on the compact
                # early-return path. This classification is local,
                # deterministic and performs no external IO.
                try:
                ...
                _fp_payload = {
                    ...
                    "topic": _fp_topic,
                    "compact_mode": bool(req.compact),
                    "deep_snapshots_omitted": bool(req.compact),
                    "debug_payload_omitted": bool(req.compact),
