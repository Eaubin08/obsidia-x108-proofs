...
async def brody_chat(req: BrodyChatRequest):
    ...
    return safe_backend_response({
        ...
        "ir_candidate": {
            "intent_type": intent, "entities": [], "constraints": [],
        ...
        "translation_trace": {
            "detected_language": req.language, "response_language": r.get("language", req.language),
            "os_trad_status": "READONLY_PASS", "alphabet_units": [],
            "os_reverse_projection": {"readonly": True, "advisory_only": True},
            "x108_boundary_status": "READONLY", "readonly": True,
            "allowed_to_decide": False, "allowed_to_act": False,
            "memory_write": False, "kernel_mutation": False, "source": "REAL_BACKEND",
        },
        "authority_snapshot": authority_snapshot,
        "automation_snapshot": automation_snapshot,
