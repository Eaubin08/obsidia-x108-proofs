...
# â”€â”€ Memory signal keywords â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

_MEMORY_SIGNALS = [
    "garde", "retient", "Ã  retenir", "important", "validÃ©", "freeze",
    "canon", "barriÃ¨re", "prochain palier", "on a stabilisÃ©",
    "Ã  faire aprÃ¨s", "pas maintenant", "plus tard", "mÃ©moire personnelle",
    "souviens", "note", "rappelle", "stabilisÃ©",
]


# â”€â”€ Personal Memory Sidecar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class PersonalMemorySidecar:
    ...
    # â”€â”€ Memory entries â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Candidates â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Readonly links â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Search (unified) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Memory signal detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

def _normalize_memory_signal_text(text: str) -> str:
    """Normalize text for robust French memory-signal detection."""
    text = (text or "").lower()
...
def detect_memory_signal(text: str) -> bool:
    """Detect local memory capture signals, accent-safe."""
    normalized = _normalize_memory_signal_text(text)
...
def build_true_runtime_payload(
    ...
    *,
    ...
    if runtime_mode == "compact_debug":
        ...
        if state.get("auto_context", False) and memory:
...
# â”€â”€ UTF-8 safe print â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Payload builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Response extractors â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ HTTP call â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Transcript â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def write_transcript_md(session_id: str, turns: list[dict[str, Any]]) -> None:
    ...
    lines = [
        f"# Brody Terminal Chat â€” Session: {session_id}",
...
def handle_command(
    ...
    if action in ("/exit", "/quit", "/q"):
        safe_print("\nBrody: Au revoir. Session sauvegardÃ©e.")
        return False, True
...
Commandes disponibles:
  /help           Ce message
  /exit, /quit    Quitter
  /debug on/off   Activer/dÃ©sactiver debug
  /compact on/off Activer/dÃ©sactiver compact
  /session <id>   Changer session_id
  /status         Afficher l'Ã©tat du client
  /save           Sauvegarder le transcript
  /last           RÃ©afficher la derniÃ¨re rÃ©ponse
  /raw            Afficher le JSON brut
  /memory status  Afficher l'Ã©tat de la mÃ©moire personnelle
  /memory show    Afficher les entrÃ©es rÃ©centes
  ...
  /memory search <q>  Rechercher dans la mÃ©moire
  /memory links   Afficher les liens readonly
  /context on/off Activer/dÃ©sactiver le contexte mÃ©moire auto
  /context show   Afficher le dernier contexte injectÃ©
""")
        ...
        if last_response:
            safe_print("\n--- DerniÃ¨re rÃ©ponse Brody ---")
            safe_print(extract_answer(last_response))
            safe_print("---")
        else:
            safe_print("Aucune rÃ©ponse prÃ©cÃ©dente.")
    ...
    # â”€â”€ Memory commands â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        if sub_cmd == "status":
            ...
            safe_print(f"""
MÃ©moire personnelle (LOCAL ONLY):
  EntrÃ©es:            {mem_count}
  Candidats:          {cand_count}
  Liens readonly:     {len(links.get('links', []))}
  Promotion autorisÃ©e: False
...
""")
            ...
            if entries:
                ...
                safe_print("Aucune entrÃ©e mÃ©moire personnelle.")
            ...
            if sub_arg:
                ...
                if result:
                    safe_print(f"Promu: {result['id'][:16]} â†’ personal_memory (LOCAL_PERSONAL_MEMORY_ONLY)")
                    safe_print("memory_write=False  graphiti_write=False  neo4j_write=False")
                else:
                    safe_print(f"Candidat {sub_arg[:16]} non trouvÃ© ou dÃ©jÃ  traitÃ©.")
            else:
            ...
            if sub_arg:
                ...
                safe_print("Candidat rejetÃ© (local)." if ok else "Candidat non trouvÃ©.")
            else:
            ...
            if gate_cmd == "status":
                from brody_memory_intake_gate import load_candidates
                candidates = load_candidates()
                safe_print(f"""
Intake Gate Status:
  Mode:              dry-run par dÃ©faut
  Pending candidates: {len(candidates)}
  Write autorisÃ©:    False (nÃ©cessite 3 env vars)
  Neo4j configurÃ©:   {'Oui' if os.environ.get('NEO4J_URI') else 'Non'}
...
""")
                ...
                safe_print(f"Pipeline trouvÃ©: {report['pipeline_found']}")
                ...
                from brody_memory_intake_gate import run_authorized_dry_run
                report = run_authorized_dry_run()
                safe_print(f"Convertis: {report['converted_count']}  RejetÃ©s: {report['rejected_count']}")
                ...
                from brody_memory_intake_gate import run_authorized_prepare_write
                ...
                from brody_memory_intake_gate import load_last_sovereign_envelope, get_sequence_state
...
""")
                ...
                safe_print("""
WRITE RÃ‰EL â€” Commandes manuelles requises:

1. DÃ©finir les variables d'approbation :
...
2. DÃ©finir les credentials Neo4j :
...
4. VÃ©rifier le ROLLBACK_PLAN avant exÃ©cution.
   Aucun write n'est dÃ©clenchÃ© depuis ce terminal.
""")
            else:
        ...
        if arg.lower() == "on":
            ...
            safe_print("Contexte mÃ©moire auto: ON")
        elif arg.lower() == "off":
            state["auto_context"] = False
            safe_print("Contexte mÃ©moire auto: OFF")
        elif arg.lower() == "show":
            ctx = state.get("_last_context", "")
            if ctx:
                safe_print(f"\n--- Dernier contexte injectÃ© ({len(ctx)} chars) ---")
                safe_print(ctx[:2000])
                safe_print("---")
            else:
                safe_print("Aucun contexte injectÃ©.")
        ...
        if memory:
            mem_info = f"""
  personal_memory: {memory.memory_count()} entrÃ©es
...
def main(endpoint: str = DEFAULT_ENDPOINT) -> None:
    ...
    # â”€â”€ UTF-8 setup â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    while running:
        ...
        # â”€â”€ Send to Brody (with optional context injection) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        try:
            ...
            safe_print("VÃ©rifiez que l'API est lancÃ©e sur http://127.0.0.1:8000")
            safe_print("Tapez /status pour l'Ã©tat, /exit pour quitter.\n")
            continue
        except TimeoutError:
            safe_print("\n[ERREUR] Timeout - l'API n'a pas rÃ©pondu dans le dÃ©lai.")
            continue
        except ValueError as e:
            safe_print(f"\n[ERREUR] RÃ©ponse invalide: {e}")
            continue

        last_response = data

        # â”€â”€ Display answer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        answer = extract_answer(data)
        safe_print(f"\nBrody > {answer}\n")

        # â”€â”€ Display boundary â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        boundary = extract_boundary(data)
        safe_print(f"Boundary: {format_boundary_line(boundary)}")

        # â”€â”€ Auto-capture memory signal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Context info line â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Source check â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Record turn â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        turn_entry = {
