# V5B — Start Obsidia API on port 8012
$ErrorActionPreference = "Stop"
Set-Location $PSScriptRoot\..

Write-Host "=== Obsidia X-108 API V5B ===" -ForegroundColor Cyan
Write-Host "Starting on http://127.0.0.1:8012" -ForegroundColor Green
...
python -m uvicorn apps.obsidia_api.main:app --host 127.0.0.1 --port 8012 --reload
