...
# Assumes the Obsidia API is already running on http://127.0.0.1:8012
...
Write-Host "Endpoint: http://127.0.0.1:8012" -ForegroundColor DarkGray
Write-Host ""

$Endpoint = if ($args.Count -gt 0) { $args[0] } else { "http://127.0.0.1:8012" }
