"""
V5A Internal Flow: V4 controlled runtime pipeline. Dry-run only.
"""
...
def run(action_id="v5a_v4_001", domain="trading", intent="query_price"):
    action = ActionCandidate(
        action_id=action_id, domain=domain, actor_id="v4_controlled_flow",
    ...
    theta = DecisionEnvelopeTheta(theta_id="theta_v4", x108_gate="ALLOW", confidence=0.9, reason_code="ALLOW_STANDARD")
...
if __name__ == "__main__":
    ...
    print("OK v4_controlled_runtime_flow")
