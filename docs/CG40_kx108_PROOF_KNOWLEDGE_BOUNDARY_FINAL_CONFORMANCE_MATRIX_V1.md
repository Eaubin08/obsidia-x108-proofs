# CG40 KX108 proof-knowledge-boundary Final Conformance Matrix V1
...
Source:
`scripts/kernel/kx108_proof_knowledge_boundary_v1.py`

Test:
`tests/cli/kernel/test_kx108_proof_knowledge_boundary_v1.py`

Historical tag:
`cg40-kx108-proof-knowledge-boundary-v1`

Historical tag target:
`6f6c321cea7b00f64d0df4ed88ba57441c16eeb3`

Current substantive source commit:
`e0bd972f64c58aaa2ad2c4b74799c17537f7af3b`

Build receipt:
`docs/CG40_BUILD_RECEIPT_V1.md`

## Final State

CG40 KX108 proof-knowledge-boundary V1 CONFORMANCE DOCUMENTED
