...
La famille Tree34 : taxonomie, activation et modèles de flux. Elle n'a jamais d'autorité finale.
...
- [periphery/cognitive_trees/](../../periphery/cognitive_trees) · arbres cognitifs

D'après le registre de fonctionnalités V3, **13 fichier(s)** du dépôt relèvent de cette couche. Principaux emplacements :

| Dossier | Fichiers |
|---|---:|
| `periphery/cognitive_trees/` | 7 |
| `specs/04_AGI_TREE34_FLUX/` | 5 |
...
Aucun document de `docs/` n'est rattaché à cette couche pour l'instant.
