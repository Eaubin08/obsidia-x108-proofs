# CG30 KX108 proof-integrity-check Final Conformance Matrix V1
...
Source:
`scripts/kernel/kx108_proof_integrity_check_v1.py`

Test:
`tests/cli/kernel/test_kx108_proof_integrity_check_v1.py`

Historical tag:
`cg30-kx108-proof-integrity-check-v1`

Historical tag target:
`88c084824aa6d696196a57ea7b4d63f55d0ccd6f`
...
CG30 KX108 proof-integrity-check V1 CONFORMANCE DOCUMENTED
