# CG29 KX108 proof-state-validation Final Conformance Matrix V1
...
Source:
`scripts/kernel/kx108_proof_state_validation_v1.py`

Test:
`tests/cli/kernel/test_kx108_proof_state_validation_v1.py`

Historical tag:
`cg29-kx108-proof-state-validation-v1`

Historical tag target:
`2db4cf127b2731e60973c283e50aa85fcae2c279`
...
CG29 KX108 proof-state-validation V1 CONFORMANCE DOCUMENTED
