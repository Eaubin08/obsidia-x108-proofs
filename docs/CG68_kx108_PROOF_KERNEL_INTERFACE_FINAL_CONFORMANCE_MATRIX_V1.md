# CG68 KX108 proof-kernel-interface Final Conformance Matrix V1
...
Source:
`scripts/kernel/kx108_proof_kernel_interface_v1.py`

Test:
`tests/cli/kernel/test_kx108_proof_kernel_interface_v1.py`

Historical tag:
`cg68-kx108-proof-kernel-interface-v1`

Historical tag target:
`76b9dd1aaac0258216739d32e9d899af8e59008c`

Current substantive source commit:
`eb2f24465e03a8deaabf89d0351b1a4fe544c798`

Build receipt:
`docs/CG68_BUILD_RECEIPT_V1.md`

## Final State

CG68 KX108 proof-kernel-interface V1 CONFORMANCE DOCUMENTED
