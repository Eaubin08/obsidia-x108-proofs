# CG65 KX108 proof-envelope-integrity Final Conformance Matrix V1
...
Source:
`scripts/kernel/kx108_proof_envelope_integrity_v1.py`

Test:
`tests/cli/kernel/test_kx108_proof_envelope_integrity_v1.py`

Historical tag:
`cg65-kx108-proof-envelope-integrity-v1`

Historical tag target:
`a45f4f8cf6d80da1ee2159a86e5f4347a91b8a08`

Current substantive source commit:
`3e60a8461fde11a8b54cd0583a5d8647b6d0d79d`

Build receipt:
`docs/CG65_BUILD_RECEIPT_V1.md`

## Final State

CG65 KX108 proof-envelope-integrity V1 CONFORMANCE DOCUMENTED
