...
allowed-tools: Read, Bash(git status:*), Bash(git log:*), Bash(git diff:*), Bash(git branch --show-current)
---

Read `.claude/memory/SCRATCH.md` and `.claude/context/CURRENT_FOCUS.md`, plus run:
